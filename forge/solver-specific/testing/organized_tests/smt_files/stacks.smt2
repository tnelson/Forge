...
(assert (= State (set.union (set.singleton (tuple Initial0)) (set.singleton (tuple Mid0)) (set.singleton (tuple End0)))))
...
(declare-fun $st_some19729 (Atom) Atom)
...
(assert (and (and (forall ((s Atom)) (=> (and (set.member (tuple s) StackElement)) (and (or (not (set.subset (set.singleton (tuple s)) (rel.join Initial (rel.tclosure (set.union top prev))))) (not (set.subset (set.singleton (tuple s)) (rel.join (set.singleton (tuple s)) (rel.tclosure prev)))))))) (forall ((s Atom)) (=> (and (set.member (tuple s) StackElement)) (and (and (set.subset (set.singleton (tuple s)) (rel.join (set.singleton (tuple ($st_some19729 s))) (rel.tclosure (set.union top prev)))))))))))(check-sat)
(get-model)