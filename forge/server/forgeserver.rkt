                             ...
                             (response/xexpr
                              `(html
                                (head
                                 ...
                                 (script ((type "text/javascript") (src "https://unpkg.com/klayjs@0.4.1/klay.js")))
                                 (script ((type "text/javascript") (src "/cytoscape-klay.js")))
                                 (script ((type "text/javascript") (src "/cytoscape-avsdf.js")))
                                 (script ((type "text/javascript") (src "http://marvl.infotech.monash.edu/webcola/cola.js")))
                                 (script ((type "text/javascript") (src "/cytoscape-euler.js")))
                                 (script ((type "text/javascript") (src "/cytoscape-cola.js")))
                                 (script ((type "text/javascript") (src "https://unpkg.com/dagre@0.7.4/dist/dagre.js")))
                                 (script ((type "text/javascript") (src "cytoscape-dagre.js")))
