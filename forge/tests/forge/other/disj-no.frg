...
// }
// test expect {
//     emptyno : {noVarno iff noVarnoDisj} is theorem
// }
...
test expect {
    oneVar : {oneVarno iff oneVarnoDisj} is theorem
}
...
test expect {
    twoVar : {twoVarno iff twoVarnoDisj} is theorem
}
...
test expect {
    manyVar : {manyVarno iff manyVarnoDisj} is theorem
}