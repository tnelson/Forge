...
;    (list "froglet-uni-4.frg" #rx"Expected a sig") ;; TODO reachable, double-check
    ...
    (list "failed_sat.frg" #rx"Failed test") 
    (list "properties_undirected_tree_underconstraint_error.frg" #rx"isUndirected is sufficient for isUndirectedTree (isUndirected implies isUndirectedTree) failed.")
    (list "properties_undirected_tree_overconstraint_error.frg" #rx"TreeWithEdges is necessary for isUndirectedTree (isUndirectedTree implies TreeWithEdges) failed.")
