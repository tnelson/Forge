...
(define REGISTRY
  (list
    ...
    (list "join3.frg" #rx"was not an object, so could not access its fields.")
    (list "join-right.frg" #rx"was not an object, so could not access its fields.")
    (list "join-right2.frg" #rx"was not an object, so could not access its fields.")
    (list "join-right3.frg" #rx"was not an object, so could not access its fields.")
    (list "join-right4.frg" #rx"was not an object, so could not access its fields.")
