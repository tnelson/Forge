...
;    (list "froglet-reachable1.frg" #rx"no field match")
    ...
    (list "consistency-error.frg" #rx"Failed test consistent_assertion_for_q_thisisatestname")
    (list "inconsistency-error.frg" #rx"Failed test inconsistent_assertion_for_q_")
    (list "properties_directed_tree_necessity_error.frg" #rx".*?quantified_necessary_assertion_for_isNotRoot_tnecc.*?failed.")
