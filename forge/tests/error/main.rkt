...
(define REGISTRY
  (list
    ...
    (list "bsl-join-right.frg" #rx"is not a field")
    (list "bsl-join-right2.frg" #rx"is not a field")
    (list "bsl-join-right3.frg" #rx"is not a field")
    (list "bsl-join-right4.frg" #rx"is not a field")
    (list "bsl-join-right5.frg" #rx"is not a field")
    (list "bsl-join-right6.frg" #rx"is not a field")
    ...
    (list "froglet-join-right.frg" #rx"is not a field")
    (list "froglet-join-right2.frg" #rx"is not a field")
    (list "froglet-join-right3.frg" #rx"is not a field")
    (list "froglet-join-right4.frg" #rx"is not a field")
    (list "froglet-join-right5.frg" #rx"is not a field")
    (list "froglet-join-right6.frg" #rx"is not a field")
    (list "froglet-join.frg" #rx"not a singleton")
    (list "froglet-join2.frg" #rx"did not result in a singleton") 
    (list "froglet-join3.frg" #rx"not a singleton")
...
;    (list "froglet-reachable1.frg" #rx"no field match")
    ...
    (list "./loc/inst-bad-atom-inherit.frg" #rx"inst-bad-atom-inherit.frg:13:.*Bounds conflict.*child sig Child")
